    ...
    return (
      <ImageBackground source={require('../img/bg.png')} style={{flex: 1,height: window.height,}}>
                 ...
                 :
                   <TouchableOpacity onPress={this.uploadImg}>
                    ...
                    ></Image>
                       ...
                       {!this.state.UserName?
                <Text style={{flex:1,color:'#000' ,fontSize:16 ,marginStart:10 ,marginEnd:10,alignItems:'center', }}  >
                {/* {strings("SideMenu.userName")} */}
                User name
                </Text> 
                 :
                 <Text style={{flex:1,color:'#000' ,fontSize:15 ,marginStart:10 ,marginEnd:10,alignItems:'center' }}> {this.state.UserName}</Text>
                      }
        ...
        <View style={{flexDirection:'row',marginStart:10,marginTop:5}}>
               ...
               style={{height:50,flexDirection:'row',marginTop:3 ,alignItems:'center',marginStart:15 , }}>
             ...
             Home
               ...
               <TouchableOpacity 
                ...
                style={{height:50,flexDirection:'row',marginTop:3 ,alignItems:'center',marginStart:15 , marginBottom:20}}>
